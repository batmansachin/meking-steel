            ...
            <div class="range range-md-justify">
                <div class="cell-md-8 cell-lg-7 cell-xl-6">
                    <div class="inset-md-right-30 inset-lg-right-0">
                        ...
                        <p>Quality is a continuous process at Making Steel – where organization-wide action is taken to increase effectiveness and efficiency of the engineering process. This means that we continuously concentrate on improving our own performance to ensure that you -the client- benefit. Our aim is to meet your expectations every time.</p>
                        <div class="well-custom">
                            <h5>Completed over 200 projects in 7 states - on time and within budget.</h5>
                        </div>
                        <p>We take a proactive stance towards quality moving beyond Quality Control to provide Quality Assurance, so you can be confident that your requirements will be met with predictable quality – consistently. Our stringent process ensures that high quality standards are reflected as results in your business, guaranteeing your satisfaction every time.</p>
                        <p>Making Steel places great emphasis on delivery of high quality products to its customers. Design and manufacturing facilities follow the Quality Management System ISO 9001:2000 procedures. All products manufactured must pass stringent quality testing procedures, a standard inspection and testing plan is followed for all jobs. Making Steel also received ISO 14001:2004 (The Environment Management System) and OHSAS 18001:2007 (The Health and Safety Management System) certifications.</p>
                    </div>
                </div>
                ...
                <img src="{{ URL::to('public/res/images/00001.jpg') }}" style="width: 775px; height: 450px">
                <img src="{{ URL::to('public/res/images/00002.jpg') }}" style="width: 775px; height: 450px">
            </div>
        </div>
    </section>
