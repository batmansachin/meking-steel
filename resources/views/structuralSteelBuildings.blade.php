            ...
            <div class="range range-md-justify">
                <div class="cell-md-8 cell-lg-7 cell-xl-6">
                    <div class="inset-md-right-30 inset-lg-right-0">
                        <h1>Structural Steel Buildings</h1>
                        <p>we offer its expertise in the fabrication and installation of structural steel and plate works for various industrial and commercial applications.</p>
                        ...
                        <li>Built-up Girders and Columns</li>
